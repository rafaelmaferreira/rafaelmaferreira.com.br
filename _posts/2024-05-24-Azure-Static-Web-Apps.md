...
Crie um arquivo .github/workflows/deploy.yml com o seguinte conteúdo, acrescente dentro do "azure_static_web_apps_api_token" o contéudo de: "secrets.AZURE_STATIC_WEB_APPS_API_TOKEN" dentro de duas {{}} e repo_token acrescente: "secrets.GITHUB_TOKEN" dentro de duas {{}} após o o $:
