...
Crie um arquivo .github/workflows/deploy.yml com o seguinte conteúdo, adicione dentro do "azure_static_web_apps_api_token" o contéudo de: "{{secrets.AZURE_STATIC_WEB_APPS_API_TOKEN}}" e repo_token adicione: {{secrets.GITHUB_TOKEN}} após o $:
