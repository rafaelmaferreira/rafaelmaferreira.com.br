...
## Passo 1: Configurar a API com Node.js e Express
...
Passo 2: Adicionar Swagger para Documentação Interativa
...
Passo 3: Adicionar Doxygen para Documentação do Código-Fonte
...
Passo 4: Fazer o Deploy no Azure Static Web Apps
...
Adição de um Private Endpoint (Opcional)
